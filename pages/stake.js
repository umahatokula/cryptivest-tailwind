        ...
        <div className="w-full md:w-10/12 mb-20 mx-auto">
            <div className="flex flex-row flex-wrap">
                <div className="bg-[#272459] p-10 w-full mb-4 md:w-2/3 rounded-[20px] md:mt-0 md:mb-4 md:p-16 md:space-y-4">
                    <div>
                        <p className="text-2xl text-white font-extrabold md:text-4xl md:my-4">ERC Tokens</p>
                    ...
                    <div className="my-6">
                        <form>
                            ...
                            <div className="w-full md:w-1/3 md:inline-block">
                                <button onClick={(e) => stakeEther(e)} className="w-full my-4 bg-gradient-to-br from-[#0047ff] to-[#57048a] px-10 py-4 rounded-xl text-white font-black hover:bg-red-300 md:ml-4">Stake</button>
                            </div>
                        </form>
                    </div>
                </div>
